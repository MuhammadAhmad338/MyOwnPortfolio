        ...
        <div className={`${darkMode ? 'bg-zinc-900' : 'bg-gray-100'} px-10 py-10 mt-12 rounded-xl ${darkMode ? 'text-white' : 'text-gray-800'} transition-colors duration-200`}>
            <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-4">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/muhammad-ahmad-9005a6253" title="Follow on LinkedIn" aria-label="Follow on LinkedIn" className="w-8 h-8 rounded-full bg-black flex items-center justify-center text-white" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4 fill-current">
