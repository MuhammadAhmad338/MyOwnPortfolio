      ...
      <div className="px-2 sm:px-4 pt-3" style={{ maxWidth: '608px', width: '100%' }}>
        <nav className={`px-2 py-2 shadow-lg rounded-xl flex justify-between items-center transition-colors duration-200`} style={{ backgroundColor: darkMode ? '#2c2c2c' : 'white' }}>
          ...
          <div className="flex space-x-3 sm:space-x-4">
            ...
            <Link href="/">
              <div className="relative group">
                ...
                >
                  <Image src={home} alt="Home" width={26} height={26} priority className={darkMode ? 'invert' : ''} />
                </button>
              ...
              <div className="relative group">
                <button
                  ...
                  ${darkMode ? 'text-white hover:bg-zinc-700' : 'text-gray-800 hover:bg-gray-200'}
                   focus:outline-none`}
                >
                  <Image src={userprofile} alt="Home" width={26} height={26} priority className={darkMode ? 'invert' : ''} />
                </button>
                <div className={`absolute bottom-full -mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 rounded-full text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none ${darkMode ? 'bg-zinc-800 text-white' : 'bg-white text-gray-800'} shadow-md`}>
                  about
                </div>
            ...
            <Link href="/projects">
              <div className="relative group">
                <button
                  ...
                  focus:outline-none`}
                >
                  <Image src={bag} alt="Home" width={26} height={26} priority className={darkMode ? 'invert' : ''} />
                </button>
                <div className={`absolute bottom-full -mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 rounded-full text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none ${darkMode ? 'bg-zinc-800 text-white' : 'bg-white text-gray-800'} shadow-md`}>
                  projects
                </div>
            ...
            <Link href="/skills">
              <div className="relative group">
               ...
               focus:outline-none`}
                >
                  <Image src={skills} alt="Home" width={26} height={26} priority className={darkMode ? 'invert' : ''} />
                </button>
                <div className={`absolute bottom-full -mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 rounded-full text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none ${darkMode ? 'bg-zinc-800 text-white' : 'bg-white text-gray-800'} shadow-md`}>
                  skills
                </div>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            >
              {darkMode ? (
                <Image src={lightmode} alt="Light Mode" width={24} height={24} priority className="invert" />
              ) : (
