    ...
    return (
      ...
      `}
            ...
            <Image
                src={women}
                alt='logo'
                className='w-20 h-20 p-4 object-cover rounded-full'
                priority
            />
...

            {
                articledata.map((item, index) => (
                    <div key={index} className='p-4'>
                        <Image src={women} alt='hellworld' className='w-full h-96 object-cover rounded-lg mb-4' />
                        <p>{item.desc}</p>
                        <div className='flex flex-col items-start justify-between mt-4'>
                            <h1 className='font-bold text-2xl'>My Solution</h1>
                            <Image src={women} alt='hellworld' className='w-full h-96 object-cover mt-4 rounded-lg mb-4' />
                            <p>{item.solution}</p>
                        </div>
                    </div>
                ))
