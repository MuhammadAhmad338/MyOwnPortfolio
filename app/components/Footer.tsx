...
const Footer = () => {
    ...
    return (
        <div className={`${darkMode ? 'bg-zinc-900' : 'bg-gray-100'} px-4 py-6 sm:px-10 sm:py-10 mt-4 mb-2 rounded-xl ${darkMode ? 'text-white' : 'text-gray-600'} transition-colors duration-200`}>
            <div className="flex flex-col items-center space-y-3">
                <p className="text-xs sm:text-sm font-medium text-center">© {new Date().getFullYear()} Muhammad Ahmad – All Rights Reserved</p>
