...
const Home: FC = () => {
    ...
    return (
        <div className={`${darkMode ? 'bg-zinc-800' : 'bg-white'} ${darkMode ? 'text-white' : 'text-gray-800'} px-2 py-2 rounded-2xl mx-auto w-full max-w-xl shadow-lg transition-colors duration-200`}>
            {/* Header Section */}
            <div className='m-4'>
