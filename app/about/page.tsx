...
const About: FC = () => {
    ...
    return (
        ...
        >
            ...
            <div className={`${darkMode ? 'bg-zinc-900' : 'bg-gray-100'} px-10 py-10 mt-12 rounded-xl ${darkMode ? 'text-white' : 'text-gray-800'} transition-all duration-500`}>
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <div className={`w-2 h-2 ${darkMode ? 'bg-gray-500' : 'bg-gray-400'} rounded-full mr-2 transition-all duration-500`}></div>
            ...
            <div className={`${darkMode ? 'bg-zinc-900' : 'bg-gray-100'} px-10 py-10 mt-4 mb-2 rounded-xl ${darkMode ? 'text-white' : 'text-gray-600'} transition-all duration-500`}>
