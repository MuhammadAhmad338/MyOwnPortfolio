    ...
    return (
        ...
        >
            ...
            <div className="space-y-4 sm:space-y-6 px-3 sm:px-4 mb-6 sm:mb-8 pb-4">
                ...
                <p className={`text-xs sm:text-base ${darkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed transition-all duration-500`}>
                I hold a bachelor's degree in Software Engineering from Riphah International University and have a strong passion for staying up-to-date with the latest technologies and development trends. With 3 years of specialized experience in Flutter and full stack development, I've built robust applications  and APIs. I'm now expanding my skill set to include cloud technologies, containerization, and infrastructure as code to transition into cloud architecture roles.
                </p>
